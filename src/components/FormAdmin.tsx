      ...
      <form className="w-full max-w-lg p-8" ref={formRef}>
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            <Select id="gender" options={["Masculino", "Femenino"]} defaultValue={user ? user.gender : ""} />
          </div>
          <div className="w-full md:w-1/2 px-3">
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full px-3">
            ...
            <Input id="birthdate" type="date" defaultValue={user ? user.birthdate.toString() : ""} />
          </div>
        </div>
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full px-3">
            <Label htmlFor="password">Contraseña</Label>
            <Input id="password" type="password" defaultValue={user ? user.password : ""} />
          </div>
        </div>
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full px-3">
        ...
        <div className="my-6 w-full text-gray-600">
          <Button id={"Save"} color="blue" onClick={() => { saveUser(user, formRef.current ? new FormData(formRef.current) : null)}}>Guardar cambios</Button>
        </div>
        <div className="flex flex-wrap -mx-3 mb-6">
          <div className="w-full px-3">
            <Label htmlFor="account-deletion">Eliminar cuenta</Label>
            <div className="my-6 w-full text-gray-600">
              <Button id="account-deletion" color="blue" onClick={() => { deleteUser(userID)}}>
                Eliminar
              </Button>
            </div>
          </div>
